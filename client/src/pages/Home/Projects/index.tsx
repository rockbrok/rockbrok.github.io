...
const Projects = () => {
  ...
  const p3paragraph1 = "I am currently building an application for my final project of Harvard's CS50X course with my friend. I am building the frontend and she is building the backend. This app allows users to upload audio of the rain and is meant to provide stress relief to users. I am using the Leaflet library to display the upload location of each audio file."
  const p3paragraph2 = ""
  const p4paragraph1 = "My next project is currently a work in progress. I am building a React app for a mock online coffee store. User authentication will be made possible using JSON Web Tokens (JWT), and React Stripe will be used to integrate Stripe's payment services into the app. I'm using MongoDB for the back end to store user and item data. Three.js is used to render a 3D scene on the homepage."
